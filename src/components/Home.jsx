    ...
    <div name='home' className='h-screen w-full bg-gradient-to-b from-black via-black to-indigo-900'>
      ...
      <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
        <div className='flex flex-col justify-center h-full'>
          ...
          <Link to="projects" smooth duration={500} className='group text-white w-fit px-6 py-3 my-2 flex items-centers rounded-md bg-gradient-to-r from-indigo-200 to-indigo-500 cursor-pointer'>Projects
